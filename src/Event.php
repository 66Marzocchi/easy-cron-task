...
//        parent::__construct($config);
     ...
     * @param $app
     */
    protected function runCommandInForeground($app)
    {
        (new Process(
     ...
     * @param $app
     */
    protected function callAfterCallbacks($app)
    {
     ...
     * @param $app
     */
    protected function runCommandInBackground($app)
    {
//        chdir(dirname($app->request->getScriptFile()));
    ...
    public function emailOutputTo($addresses)
    {
        ...
        return $this->then(function ($app) use ($addresses) {
